...
--
-- Host: localhost
-- Generation Time: Jun 28, 2018 at 02:20 PM
...
--   `city_id` char(4) COLLATE utf8_unicode_ci NOT NULL,
--   `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `districts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `districts_id_index` (`city_id`);
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`);
